...
- With the *Character* or *Both* target, a reply's tracker now remembers which swipe it was generated for. Swiping back to an older swipe, or editing the reply, marks it stale; it is regenerated once, for the text actually shown, the next time it is needed (your next send). Navigating swipes never triggers generations by itself.
